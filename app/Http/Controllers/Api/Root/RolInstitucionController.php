...
class RolInstitucionController extends Controller
{
    ...
    public function index(Request $request, $institutionId = null): JsonResponse
    {
        ...
        $roles = Rol::join('auth.institution_roles', function ($join) use ($institutionId) {
    ...
    {
        try {
            $response = RolInstitucion::with('rol')->find($id);
    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            $request->validate([
                ...
                'role_id' => 'required|uuid|exists:App\Models\Rol,id'
            ]);

            $rolInstitucion = RolInstitucion::updateOrCreate(
                [
    ...
    public function update(Request $request, $id): JsonResponse
    {
        try {
            ...
            $rolInstitucion = RolInstitucion::findOrFail($id);
            $rolInstitucion->update([
                'is_active' => $isEnabled
            ]);
