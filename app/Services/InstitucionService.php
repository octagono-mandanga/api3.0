...
class InstitucionService
{
     ...
     */
    public function updateInstitucionLogo(Institucion $institucion, string $base64Image): string
    {
        try {
            ...
            $fileName = "logo-{$institucion->id}.jpg";
            $directory = "instituciones/logos";
            ...
            $institucion->update(['logo_url' => $publicUrl]);

            return $publicUrl;

        } catch (\Exception $e) {
            Log::error("Error procesando logo para institución {$institucion->id}: " . $e->getMessage());
            throw $e;
        }
    }
     ...
     */
    public function updateBranding(Institucion $institucion, array $colors): Institucion
    {
