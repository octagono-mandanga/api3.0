...
/**
 * Seeder completo de departamentos y municipios de Colombia.
 * Datos basados en la División Político-Administrativa (DIVIPOLA) del DANE.
 * 33 departamentos + ~1.122 municipios con códigos DANE oficiales.
 */
class DepartamentosMunicipiosSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ($data as $depto) {
            $deptoId = DB::table('ref.departamentos')->insertGetId([
                'nombre' => $depto['nombre'],
                'codigo' => $depto['codigo'],
                'estado' => 'activo',
            ]);
            ...
            // Insertar en bloques de 100 para rendimiento
            foreach (array_chunk($municipiosChunk, 100) as $chunk) {
                DB::table('ref.municipios')->insert($chunk);
            }
        }
    }

    /**
     * Retorna la estructura completa: departamentos con sus municipios.
     * Códigos DANE: Departamento (2 dígitos), Municipio (5 dígitos).
     */
        ...
        return [
            ...
            [
                ...
                'municipios' => [
                    ...
                    ['codigo' => '05044', 'nombre' => 'Santa Fe de Antioquia'],
            ...
            [
                ...
                'municipios' => [
                    ...
                    ['codigo' => '15763', 'nombre' => 'Soracá'],
                    ['codigo' => '15764', 'nombre' => 'Sotaquirá'],
            ...
            // ─────────────────────────────────────────────────────
            // 15. CUNDINAMARCA (25) — 116 municipios
            // ─────────────────────────────────────────────────────
            [
            ...
            // ─────────────────────────────────────────────────────
            // 19. LA GUAJIRA (44) — 15 municipios
            // ─────────────────────────────────────────────────────
            [
            ...
            // ─────────────────────────────────────────────────────
            // 23. NORTE DE SANTANDER (54) — 40 municipios
            // ─────────────────────────────────────────────────────
            [
            ...
            // ─────────────────────────────────────────────────────
            // 27. SAN ANDRÉS Y PROVIDENCIA (88)
            // ─────────────────────────────────────────────────────
            [
            ...
            [
                ...
                'municipios' => [
                    ...
                    ['codigo' => '70204', 'nombre' => 'Chalán'],
                    ['codigo' => '70215', 'nombre' => 'Coloso'],
                    ['codigo' => '70221', 'nombre' => 'Corozal'],
                    ['codigo' => '70230', 'nombre' => 'Coveñas'],
                    ...
                    ['codigo' => '70820', 'nombre' => 'Tolú'],
                    ['codigo' => '70823', 'nombre' => 'Toluviejo'],
                ],
            ],

            // ─────────────────────────────────────────────────────
            // 30. TOLIMA (73) — 47 municipios
            // ─────────────────────────────────────────────────────
            [
                ...
                'municipios' => [
                    ...
                    ['codigo' => '73055', 'nombre' => 'Ataco'],
                    ['codigo' => '73067', 'nombre' => 'Cajamarca'],
                    ['codigo' => '73124', 'nombre' => 'Carmen de Apicalá'],
                    ['codigo' => '73148', 'nombre' => 'Casabianca'],
                    ['codigo' => '73152', 'nombre' => 'Chaparral'],
                    ['codigo' => '73168', 'nombre' => 'Coello'],
                    ['codigo' => '73200', 'nombre' => 'Coyaima'],
                    ['codigo' => '73217', 'nombre' => 'Cunday'],
                    ['codigo' => '73226', 'nombre' => 'Dolores'],
                    ['codigo' => '73236', 'nombre' => 'Espinal'],
                    ['codigo' => '73268', 'nombre' => 'Falan'],
                    ['codigo' => '73270', 'nombre' => 'Flandes'],
                    ['codigo' => '73275', 'nombre' => 'Fresno'],
                    ['codigo' => '73283', 'nombre' => 'Guamo'],
                    ['codigo' => '73319', 'nombre' => 'Herveo'],
                    ['codigo' => '73347', 'nombre' => 'Honda'],
                    ['codigo' => '73349', 'nombre' => 'Icononzo'],
                    ['codigo' => '73352', 'nombre' => 'Lérida'],
                    ['codigo' => '73408', 'nombre' => 'Líbano'],
                    ['codigo' => '73411', 'nombre' => 'San Sebastián de Mariquita'],
                    ['codigo' => '73443', 'nombre' => 'Melgar'],
                    ['codigo' => '73449', 'nombre' => 'Murillo'],
                    ['codigo' => '73461', 'nombre' => 'Natagaima'],
                    ['codigo' => '73483', 'nombre' => 'Ortega'],
                    ['codigo' => '73504', 'nombre' => 'Palocabildo'],
                    ['codigo' => '73520', 'nombre' => 'Piedras'],
                    ['codigo' => '73547', 'nombre' => 'Planadas'],
                    ['codigo' => '73555', 'nombre' => 'Prado'],
                    ['codigo' => '73563', 'nombre' => 'Purificación'],
                    ['codigo' => '73585', 'nombre' => 'Rioblanco'],
                    ['codigo' => '73616', 'nombre' => 'Roncesvalles'],
                    ['codigo' => '73622', 'nombre' => 'Rovira'],
                    ['codigo' => '73624', 'nombre' => 'Saldaña'],
                    ['codigo' => '73671', 'nombre' => 'San Antonio'],
                    ['codigo' => '73675', 'nombre' => 'San Luis'],
                    ['codigo' => '73678', 'nombre' => 'Santa Isabel'],
                    ['codigo' => '73686', 'nombre' => 'Suárez'],
                    ['codigo' => '73770', 'nombre' => 'Valle de San Juan'],
                    ['codigo' => '73854', 'nombre' => 'Venadillo'],
                    ['codigo' => '73861', 'nombre' => 'Villahermosa'],
                    ['codigo' => '73870', 'nombre' => 'Villarrica'],
                    ['codigo' => '73873', 'nombre' => 'Armero'],
                ],
            ],

            // ─────────────────────────────────────────────────────
            // 31. VALLE DEL CAUCA (76) — 42 municipios
            // ─────────────────────────────────────────────────────
            [
                ...
                'municipios' => [
                    ...
                    ['codigo' => '76530', 'nombre' => 'Pradera'],
                    ['codigo' => '76548', 'nombre' => 'Restrepo'],
                    ['codigo' => '76563', 'nombre' => 'Riofrío'],
                    ['codigo' => '76606', 'nombre' => 'Roldanillo'],
                    ['codigo' => '76616', 'nombre' => 'San Pedro'],
                    ['codigo' => '76622', 'nombre' => 'Sevilla'],
                    ['codigo' => '76670', 'nombre' => 'Toro'],
                    ['codigo' => '76736', 'nombre' => 'Trujillo'],
                    ['codigo' => '76823', 'nombre' => 'Tuluá'],
                    ['codigo' => '76828', 'nombre' => 'Ulloa'],
                    ['codigo' => '76834', 'nombre' => 'Versalles'],
                    ['codigo' => '76845', 'nombre' => 'Vijes'],
                    ['codigo' => '76863', 'nombre' => 'Yotoco'],
                    ['codigo' => '76869', 'nombre' => 'Yumbo'],
                    ['codigo' => '76890', 'nombre' => 'Zarzal'],
                ],
            ],
